...
CREATE TABLE "new_calorie_banks" (
    ...
    "expiredAmount" REAL NOT NULL DEFAULT 0,
...
INSERT INTO "new_calorie_banks" ("allowNegative", "carbsTargetG", "createdAt", "currentBalance", "dailyTarget", "expireAfterDays", "fatTargetG", "id", "proteinTargetG", "recommendedSpend", "spendByDate", "totalBanked", "totalSpent", "updatedAt", "userId", "weeklyAverage") SELECT "allowNegative", "carbsTargetG", "createdAt", "currentBalance", "dailyTarget", "expireAfterDays", "fatTargetG", "id", "proteinTargetG", "recommendedSpend", "spendByDate", "totalBanked", "totalSpent", "updatedAt", "userId", "weeklyAverage" FROM "calorie_banks";
